...
#ifndef NETLINK_FF
/*
 * Stage 2 only needs the vendor FF protocol number for ask-fci/libfci
 * communication. Keep it local here instead of widening the global netlink
 * UAPI to the broader vendor ASK set.
 */
